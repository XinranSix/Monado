...
public:
    ...
    virtual void OnAttach() override {
        ...
        m_SimplePBRShader.reset(Monado::Shader::Create("sandbox/assets/shaders/simplepbr.glsl"));
        m_QuadShader.reset(Monado::Shader::Create("sandbox/assets/shaders/quad.glsl"));
        m_HDRShader.reset(Monado::Shader::Create("sandbox/assets/shaders/hdr.glsl"));
        m_GridShader.reset(Monado::Shader::Create("sandbox/assets/shaders/Grid.glsl"));
        ...
        m_PBRMaterial.reset(new Monado::Material(m_SimplePBRShader));

        float x = -4.0f;
        float roughness = 0.0f;
        for (int i = 0; i < 8; i++) {
            Monado::Ref<Monado::MaterialInstance> mi(new Monado::MaterialInstance(m_PBRMaterial));
...
private:
    Monado::Ref<Monado::Shader> m_SimplePBRShader;
    Monado::Scope<Monado::Shader> m_QuadShader;
    Monado::Scope<Monado::Shader> m_HDRShader;
    Monado::Scope<Monado::Shader> m_GridShader;
    Monado::Scope<Monado::Mesh> m_Mesh;
    Monado::Scope<Monado::Mesh> m_SphereMesh, m_PlaneMesh;
    Monado::Ref<Monado::Texture2D> m_BRDFLUT;

    Monado::Ref<Monado::Material> m_PBRMaterial;
