...
public:
    ...
    virtual void OnAttach() override {
        ...
        m_VB = std::unique_ptr<Monado::VertexBuffer>(Monado::VertexBuffer::Create());
        m_VB->SetData(vertices, sizeof(vertices));

        m_IB = std::unique_ptr<Monado::IndexBuffer>(Monado::IndexBuffer::Create());
        m_IB->SetData(indices, sizeof(indices));

        m_Shader.reset(Monado::Shader::Create("sandbox/assets/shaders/shader.glsl"));
    }
    ...
    virtual void OnUpdate() override {
        ...
        Monado::UniformBufferDeclaration<sizeof(glm::vec4), 1> buffer;
...
private:
    std::unique_ptr<Monado::VertexBuffer> m_VB;
    std::unique_ptr<Monado::IndexBuffer> m_IB;
