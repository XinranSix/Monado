...
add_defines("PX_PHYSX_STATIC_LIB", "NDEBUG")
...
target("imgui")
    ...
    set_kind("static")
    add_packages("glfw", "glad", "stb", "vulkansdk")

target("monado")
    set_kind("static")
    add_files("monado/src/**.cpp")
    add_deps("imgui", "FastNoise")
    -- add_syslinks("shaderc.lib", "glslang", "GenericCodeGen", "vulkan-1.lib")
    if is_mode("debug") then 
    ...
    add_packages("opengl", "glfw", "glad", "stb", "glm", "spdlog", "entt", "box2d", "yaml-cpp", "assimp", "vulkansdk", "shaderc", "spirv-tools", "spirv-cross", "spirv-reflect", "spirv-headers", "directxshadercompiler")
...
target("sandbox")
    ...
    add_deps("monado")
    add_packages("opengl", "glfw", "glad", "glm", "stb", "spdlog", "entt", "box2d")
...
target("alvis")
    ...
    add_files("alvis/**.cpp")
    add_deps("monado") 
    add_packages("opengl", "glfw", "glad",  "glm", "spdlog", "entt", "box2d", "assimp", "vulkansdk", "shaderc", "spirv-tools", "spirv-cross", "spirv-reflect", "spirv-headers", "directxshadercompiler")
    add_links("libs/win/ComDlg32")
