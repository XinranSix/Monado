...
namespace Monado {
    ...
    void SceneRenderer::Init() {
        ...
        s_Data.CompositeShader = Shader::Create("alvis/assets/shaders/hdr.glsl");
    ...
    void SceneRenderer::GeometryPass() {
        ...
        auto viewProjection =
            s_Data.SceneData.SceneCamera.GetProjectionMatrix() * s_Data.SceneData.SceneCamera.GetViewMatrix();
