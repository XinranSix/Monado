...
namespace Monado {
    ...
    Buffer &Material::GetUniformBufferTarget(ShaderUniformDeclaration *uniformDeclaration) {
        ...
        MND_CORE_ASSERT(false, "Invalid uniform declaration domain! Material does not support this shader type.");
    ...
    MaterialInstance::~MaterialInstance() { m_Material->m_MaterialInstances.erase(this); }
