...
namespace Monado {
    ...
    namespace {
        const unsigned int ImportFlags = aiProcess_CalcTangentSpace | aiProcess_Triangulate | aiProcess_SortByPType |
    ...
    struct LogStream : public Assimp::LogStream {
        ...
        void write(const char *message) override { MND_CORE_ERROR("Assimp error: {0}", message); }
    };
