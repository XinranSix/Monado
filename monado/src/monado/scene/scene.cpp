...
namespace Monado {
    ...
    void OnTransformConstruct(entt::registry &registry, entt::entity entity) {
        // MND_CORE_TRACE("Transform Component constructed!");
    }
    ...
    Scene::Scene(const std::string &debugName) : m_DebugName(debugName), m_SceneID(++s_SceneIDCounter) {
    ...
    void Scene::OnUpdate(Timestep ts) {
        ...
        MND_CORE_ASSERT(camera, "Scene does not contain any cameras!");
        camera->OnUpdate(ts);
    ...
    void Scene::DestroyEntity(Entity entity) { m_Registry.destroy(entity.m_EntityHandle); }
