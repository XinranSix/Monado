...
namespace Monado {
    ...
    Scene::Scene(const std::string &debugName, bool isEditorScene) : m_DebugName(debugName) {
    ...
    void Scene::OnRenderRuntime(Timestep ts) {
        ...
        // Process lights
        {
            ...
            for (auto entity : lights) {
                ...
                m_LightEnvironment.DirectionalLights[directionalLightIndex++] = { direction, lightComponent.Radiance,
    ...
    void Scene::OnRenderEditor(Timestep ts, const EditorCamera &editorCamera) {
        ...
        SceneRenderer::BeginScene(
            this, { editorCamera, editorCamera.GetViewMatrix(), 0.1f, 1000.0f, 45.0f }); // TODO: real values
        for (auto entity : group) {
    ...
    void Scene::OnRuntimeStart() {
        ...
        // If the entity doesn't have a rigidbody but has a collider, give it a default rigidbody
        {
            ...
            for (auto entity : view) {
                if (m_Registry.any_of<BoxColliderComponent, SphereColliderComponent, CapsuleColliderComponent,
                                      MeshColliderComponent>(entity)) {
                    Entity e = { entity, this };
