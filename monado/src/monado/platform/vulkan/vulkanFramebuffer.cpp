        ...
        if (!m_Specification.SwapChainTarget) {
            ...
            Renderer::Submit([instance, width, height]() mutable {
                ...
                for (auto image : instance->m_Attachments) {
                    ...
                    instance->m_ClearValues[attachmentIndex].color = { { clearColor.r, clearColor.g, clearColor.b,
                                                                         clearColor.a } };
                    colorAttachmentReferences[attachmentIndex] = { attachmentIndex,
                ...
                if (instance->m_DepthAttachment) {
                    VkFormat depthFormat =
                        instance->m_DepthAttachment->GetFormat() == ImageFormat::DEPTH32F
                    ...
                    VK_CHECK_RESULT(
                        vkCreateImageView(device, &depthStencilImageViewCreateInfo, nullptr, &info.ImageView));
                    ...
                    attachmentDescription.samples = VK_SAMPLE_COUNT_1_BIT;
                    attachmentDescription.loadOp = VK_ATTACHMENT_LOAD_OP_CLEAR;
                    attachmentDescription.storeOp = VK_ATTACHMENT_STORE_OP_STORE; // TODO: if sampling, needs to be
                                                                                  // store (otherwise DONT_CARE is fine)
                    attachmentDescription.stencilLoadOp = VK_ATTACHMENT_LOAD_OP_DONT_CARE;
                    attachmentDescription.stencilStoreOp = VK_ATTACHMENT_STORE_OP_DONT_CARE;
                    attachmentDescription.initialLayout = VK_IMAGE_LAYOUT_UNDEFINED;
