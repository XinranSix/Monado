...
namespace Monado {
    ...
    void VulkanSwapChain::InitSurface(GLFWwindow *windowHandle) {
        ...
        MND_CORE_ASSERT(graphicsQueueNodeIndex != UINT32_MAX);
        MND_CORE_ASSERT(presentQueueNodeIndex != UINT32_MAX);
    ...
    void VulkanSwapChain::Create(uint32_t *width, uint32_t *height, bool vsync) {
        ...
        MND_CORE_ASSERT(presentModeCount > 0, "");

        std::vector<VkPresentModeKHR> presentModes(presentModeCount);
        VK_CHECK_RESULT(fpGetPhysicalDeviceSurfacePresentModesKHR(physicalDevice, m_Surface, &presentModeCount,
                                                                  presentModes.data()));
    ...
    void VulkanSwapChain::CreateDrawBuffers() {
        ...
        VK_CHECK_RESULT(vkAllocateCommandBuffers(m_Device->GetVulkanDevice(), &commandBufferAllocateInfo,
                                                 m_DrawCommandBuffers.data()));
    }

    void VulkanSwapChain::OnResize(uint32_t width, uint32_t height) {
        MND_CORE_WARN("VulkanContext::OnResize");
        ...
        vkFreeCommandBuffers(device, m_CommandPool, static_cast<uint32_t>(m_DrawCommandBuffers.size()),
                             m_DrawCommandBuffers.data());
        CreateDrawBuffers();
    ...
    void VulkanSwapChain::Present() {
        ...
        // VK_CHECK_RESULT(vkWaitForFences(m_Device->GetVulkanDevice(), 1, &m_WaitFences[m_CurrentBufferIndex], VK_TRUE,
    ...
    VkResult VulkanSwapChain::AcquireNextImage(VkSemaphore presentCompleteSemaphore, uint32_t *imageIndex) {
        ...
        return fpAcquireNextImageKHR(m_Device->GetVulkanDevice(), m_SwapChain, UINT64_MAX, presentCompleteSemaphore,
