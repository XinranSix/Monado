...
namespace Monado {
    ...
    OpenGLTexture2D::OpenGLTexture2D(ImageFormat format, uint32_t width, uint32_t height, const void *data)
        ...
        Renderer::Submit([=]() { m_Image->Invalidate(); });
    }
    ...
    void OpenGLTexture2D::Bind(uint32_t slot) const {
        ...
        Renderer::Submit([slot, image]() { glBindTextureUnit(slot, image->GetRendererID()); });
    }
    ...
    uint32_t OpenGLTexture2D::GetMipLevelCount() const { return Utils::CalculateMipCount(m_Width, m_Height); }
    ...
    OpenGLTextureCube::OpenGLTextureCube(ImageFormat format, uint32_t width, uint32_t height, const void *data) {
        ...
        Renderer::Submit([instance, levels]() mutable {
            ...
            glTextureStorage2D(instance->m_RendererID, levels, Utils::OpenGLImageInternalFormat(instance->m_Format),
            ...
            if (instance->m_LocalStorage.Data)
                glTextureSubImage3D(instance->m_RendererID, 0, 0, 0, 0, instance->m_Width, instance->m_Height, 6,
                                    Utils::OpenGLImageFormat(instance->m_Format),
                                    Utils::OpenGLFormatDataType(instance->m_Format), instance->m_LocalStorage.Data);
    ...
    uint32_t OpenGLTextureCube::GetMipLevelCount() const { return Utils::CalculateMipCount(m_Width, m_Height); }
