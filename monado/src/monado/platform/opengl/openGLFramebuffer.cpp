...
namespace Monado {
    ...
    namespace Utils {
        ...
        static Ref<Image2D> CreateAndAttachColorAttachment(int samples, ImageFormat format, uint32_t width,
    ...
    OpenGLFramebuffer::OpenGLFramebuffer(const FramebufferSpecification &spec)
        ...
        MND_CORE_ASSERT(spec.Attachments.Attachments.size());
        ...
        Renderer::Submit([instance]() mutable {
            ...
            if (instance->m_ColorAttachmentFormats.size()) {
                ...
                for (size_t i = 0; i < instance->m_ColorAttachments.size(); i++)
                    instance->m_ColorAttachments[i] = Utils::CreateAndAttachColorAttachment(
                        instance->m_Specification.Samples, instance->m_ColorAttachmentFormats[i], instance->m_Width,
                        instance->m_Height, i);
            }

            if (instance->m_DepthAttachmentFormat != ImageFormat::None) {
                instance->m_DepthAttachment =
                    Utils::AttachDepthTexture(instance->m_Specification.Samples, instance->m_DepthAttachmentFormat,
