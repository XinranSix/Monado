                    ...
                    if (ImGui::BeginMenu("New")) {
                        ...
                        if (ImGui::BeginMenu("Shaders")) {
                            if (ImGui::MenuItem("Shader")) {
                                MND_CORE_INFO("Creating Shader File...");
                            }

                            if (ImGui::MenuItem("Shader Graph")) {
                                MND_CORE_INFO("Creating Shader Graph...");
                            }
            ...
            if (ImGui::BeginDragDropTarget()) {
                ...
                if (data) {
                    ...
                    if (m_AssetManager.MoveFile(a, m_MovePath)) {
                        MND_CORE_INFO("Moved File: " + a + " to " + m_MovePath);
                    }
                    m_IsDragging = false;
                }
                ImGui::EndDragDropTarget();
    ...
    void AssetManagerPanel::RenderBreadCrumbs() {
        ImGui::BeginChild("##directory_breadcrumbs", ImVec2(ImGui::GetColumnWidth() - 100, 30));
        {
            ...
            for (int i = 0; i < data.size(); i++) {
                ...
                /* Multiply the size of the folder name with 7(magic number) to set the size of selectable widget
                 * properly */
