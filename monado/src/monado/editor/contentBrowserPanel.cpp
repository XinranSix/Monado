...
namespace Monado {
                        ...
                        if (ImGui::BeginMenu("Create")) {
                            if (ImGui::MenuItem("Folder")) {
                                ...
                                if (created) {
                                    ...
                                    memset(m_RenameBuffer, 0, MAX_INPUT_BUFFER_LENGTH);
                                    memcpy(m_RenameBuffer, createdDirectory->FileName.c_str(),
...

        {
            ...
            if (ImGui::InputTextWithHint("", "Search...", m_SearchBuffer, MAX_INPUT_BUFFER_LENGTH)) {
                if (strlen(m_SearchBuffer) == 0) {
                    ...
                    m_CurrentDirFolders =
                        AssetManager::SearchAssets(m_SearchBuffer, m_CurrentDirectory->FilePath, AssetType::Directory);
    ...
    void ContentBrowserPanel::HandleRenaming(Ref<Asset> &asset) {
        ...
        if (m_RenamingSelected) {
            ...
            if (ImGui::InputText("##rename_dummy", m_RenameBuffer, MAX_INPUT_BUFFER_LENGTH,
