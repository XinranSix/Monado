...
namespace Monado {
            ...
            if (ImGui::BeginPopupContextWindow(0, ImGuiPopupFlags_MouseButtonRight |
                ...
                if (ImGui::BeginMenu("Create")) {
                    ...
                    if (ImGui::MenuItem("Directional Light")) {
                        ...
                        newEntity.GetComponent<TransformComponent>().Rotation =
                            glm::radians(glm::vec3 { 80.0f, 10.0f, 0.0f });
                        SetSelected(newEntity);
                    }
    ...
    static void DrawComponent(const std::string &name, Entity entity, UIFunction uiFunction) {
        ...
        if (entity.HasComponent<T>()) {
            // NOTE(Peter):
            //	This fixes an issue where the first "+" button would display the "Remove" buttons for ALL components on
            // an Entity. 	This is due to ImGui::TreeNodeEx only pushing the id for it's children if it's actually
            // open
