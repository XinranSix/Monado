...
namespace Monado {
    ...
    void SceneHierarchyPanel::OnImGuiRender() {
        ...
        m_Context->m_Registry.each([&](auto entity) { DrawEntityNode(Entity(entity, m_Context.Raw())); });
    ...
    void SceneHierarchyPanel::DrawComponents(Entity entity) {
        ...
        if (entity.HasComponent<TransformComponent>()) {
            ...
            if (ImGui::TreeNodeEx((void *)((uint32_t)entity | typeid(MeshComponent).hash_code()),
