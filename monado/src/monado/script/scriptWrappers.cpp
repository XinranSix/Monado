...
namespace Monado {
    namespace Script {
        ...
        static void AddCollidersToArray(MonoArray *array,
            ...
            for (uint32_t i = 0; i < count; i++) {
                ...
                if (entity.HasComponent<CapsuleColliderComponent>() && arrayIndex < arrayLength) {
                    ...
                    MonoObject *obj =
                        ScriptEngine::Construct("Monado.CapsuleCollider:.ctor(ulong,bool,single,single)", true, data);
                    mono_array_set(array, MonoObject *, arrayIndex++, obj);
                }
        ...
        void Monado_MaterialInstance_Destructor(Ref<Material> *_this) { delete _this; }
