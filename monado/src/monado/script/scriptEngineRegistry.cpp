   ...
   void ScriptEngineRegistry::RegisterAll()
	{
		...
		mono_add_internal_call("Monado.Physics::OverlapBoxNonAlloc_Native", Monado::Script::Monado_Physics_OverlapBoxNonAlloc);
		mono_add_internal_call("Monado.Physics::OverlapCapsuleNonAlloc_Native", Monado::Script::Monado_Physics_OverlapCapsuleNonAlloc);
		mono_add_internal_call("Monado.Physics::OverlapSphereNonAlloc_Native", Monado::Script::Monado_Physics_OverlapSphereNonAlloc);
		...
		mono_add_internal_call("Monado.TransformComponent::GetTransform_Native", Monado::Script::Monado_Entity_GetTransform);
		mono_add_internal_call("Monado.TransformComponent::SetTransform_Native", Monado::Script::Monado_Entity_SetTransform);
		mono_add_internal_call("Monado.TransformComponent::GetRelativeDirection_Native", Monado::Script::Monado_TransformComponent_GetRelativeDirection);
		mono_add_internal_call("Monado.TransformComponent::GetRotation_Native", Monado::Script::Monado_TransformComponent_GetRotation);
		mono_add_internal_call("Monado.TransformComponent::SetRotation_Native", Monado::Script::Monado_TransformComponent_SetRotation);
		...
		mono_add_internal_call("Monado.RigidBody2DComponent::ApplyLinearImpulse_Native", Monado::Script::Monado_RigidBody2DComponent_ApplyLinearImpulse);
		mono_add_internal_call("Monado.RigidBody2DComponent::GetLinearVelocity_Native", Monado::Script::Monado_RigidBody2DComponent_GetLinearVelocity);
		mono_add_internal_call("Monado.RigidBody2DComponent::SetLinearVelocity_Native", Monado::Script::Monado_RigidBody2DComponent_SetLinearVelocity);

		mono_add_internal_call("Monado.RigidBodyComponent::AddForce_Native", Monado::Script::Monado_RigidBodyComponent_AddForce);
		mono_add_internal_call("Monado.RigidBodyComponent::AddTorque_Native", Monado::Script::Monado_RigidBodyComponent_AddTorque);
		mono_add_internal_call("Monado.RigidBodyComponent::GetLinearVelocity_Native", Monado::Script::Monado_RigidBodyComponent_GetLinearVelocity);
		mono_add_internal_call("Monado.RigidBodyComponent::SetLinearVelocity_Native", Monado::Script::Monado_RigidBodyComponent_SetLinearVelocity);
		mono_add_internal_call("Monado.RigidBodyComponent::Rotate_Native", Monado::Script::Monado_RigidBodyComponent_Rotate);
		mono_add_internal_call("Monado.RigidBodyComponent::GetLayer_Native", Monado::Script::Monado_RigidBodyComponent_GetLayer);
		mono_add_internal_call("Monado.RigidBodyComponent::GetMass_Native", Monado::Script::Monado_RigidBodyComponent_GetMass);
		mono_add_internal_call("Monado.RigidBodyComponent::SetMass_Native", Monado::Script::Monado_RigidBodyComponent_SetMass);

		mono_add_internal_call("Monado.Input::IsKeyPressed_Native", Monado::Script::Monado_Input_IsKeyPressed);
		mono_add_internal_call("Monado.Input::IsMouseButtonPressed_Native", Monado::Script::Monado_Input_IsMouseButtonPressed);
		...
		mono_add_internal_call("Monado.MaterialInstance::Destructor_Native", Monado::Script::Monado_MaterialInstance_Destructor);
		mono_add_internal_call("Monado.MaterialInstance::SetFloat_Native", Monado::Script::Monado_MaterialInstance_SetFloat);
		mono_add_internal_call("Monado.MaterialInstance::SetVector3_Native", Monado::Script::Monado_MaterialInstance_SetVector3);
		mono_add_internal_call("Monado.MaterialInstance::SetVector4_Native", Monado::Script::Monado_MaterialInstance_SetVector4);
		mono_add_internal_call("Monado.MaterialInstance::SetTexture_Native", Monado::Script::Monado_MaterialInstance_SetTexture);
