...
namespace Monado {
    ...
    void OpenGLVertexArray::AddVertexBuffer(const Ref<VertexBuffer> &vertexBuffer) {
        ...
        for (const auto &element : layout) {
            // ����һ��ͨ�ö����������ݵ�����
            // ���� int float mat��ͬ���͵�ͨ�ö����������ݵ����鲼�ֲ�һ��������Ҫ�ֿ�д
            switch (element.Type) {
            ...
            case ShaderDataType::Bool: {
                // glVertexAttribIPointer ��ͬ glVertexAttribPointer
                glEnableVertexAttribArray(m_VertexBufferIndex);
            ...
            case ShaderDataType::Mat4: {
                ...
                for (uint8_t i = 0; i < count; i++) {
                    glEnableVertexAttribArray(m_VertexBufferIndex);
                    glVertexAttribPointer(
                        m_VertexBufferIndex, count, ShaderDataTypeToOpenGLBaseType(element.Type),
                        element.Normalized ? GL_TRUE : GL_FALSE, layout.GetStride(),
            ...
            default: MND_CORE_ASSERT(false, "Unknown ShaderDataType!");
            }
        }
