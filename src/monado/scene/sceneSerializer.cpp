...
namespace Monado {
    ...
    static void SerializeEntity(YAML::Emitter &out, Entity entity) {
        //    MND_CORE_ASSERT(entity.HasComponent<IDComponent>(), "asdas");
    ...
    void SceneSerializer::SerializeRuntim(const std::string &filepath) { MND_CORE_ASSERT(false, "asdas"); }
    ...
    bool SceneSerializer::DeSerialize(const std::string &filepath) {
        ...
        if (entities) {
            for (auto entity : entities) {
                ...
                Entity deserializedEntity = m_Scene->CreateEnitty(name);
